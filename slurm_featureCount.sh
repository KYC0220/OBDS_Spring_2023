...
featureCounts -p -T 5 -a /project/obds/kchen/1_linux/2_rnaseq/2_genome/Mus_musculus.GRCm38.102.gtf.gz \
-o counts.txt ERR1755082.bam ERR1755083.bam ERR1755086.bam ERR1755087.bam ERR1755085_sorted.bam
