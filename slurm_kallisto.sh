...
kallisto quant -i mus_musculus_ensemble_index \
-o output --rf-stranded -t 4 \
-g /project/obds/kchen/1_linux/2_rnaseq/2_genome/Mus_musculus.GRCm38.102.gtf.gz \
ERR1755082_1.fastq.gz ERR1755082_2.fastq.gz
